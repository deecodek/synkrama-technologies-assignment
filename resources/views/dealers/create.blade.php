                ...
                <form method="POST" action="{{ route('dealers.store') }}">
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <div class="mt-2">
                                <input id="zip_code" name="zip_code" type="text" required value="{{ old('zip_code') }}"
                                    class="block w-full rounded-md border-0 py-1.5 px-3 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                            </div>
                        </div>
                        ...
                        <div class="flex gap-4">
                            <button type="submit"
                                class="flex w-full justify-center rounded-md bg-indigo-600 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-indigo-500">Create
                                Location</button>
                            <a href="{{ route('dealers.index') }}"
                                class="flex w-full justify-center rounded-md bg-gray-600 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-gray-500">Cancel</a>
                        </div>
                    </div>
                </form>
            </div>
